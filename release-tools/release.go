...
var releaseCommand = cli.Command{
	...
	Flags: []cli.Flag{
		...
		cli.BoolFlag{
			Name:  "force-version",
			Usage: "Dont do semantic versioning checking",
		},
		cli.StringSliceFlag{
			Name:  "asset",
	...
	Action: func(c *cli.Context) error {
		...
		if err := gh.createRelease(c.Args().First(), c.String("commit"), c.String("version"), c.String("notes"), assets, c.Bool("force-version")); err != nil {
			return err
		}
