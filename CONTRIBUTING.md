# Contributing to the Clear Containers packaging repository

The Clear Containers packaging repository is an open source project licensed under the
...
We accept [github pull requests](https://github.com/clearcontainers/packaging/pulls).
...
The Clear Containers packaging repository maintainers will be the ones accepting or rejecting any pull request. They are listed in the OWNERS files, and there can be one OWNERS file per directory.
...
github](https://github.com/clearcontainers/packaging/issues/new) so we all get
